...
const scope_tracker_1 = __importDefault(require("./scope-tracker"));
const is_label_identifier_1 = __importDefault(require("./is-label-identifier"));
const bfs_traverse_1 = __importDefault(require("./bfs-traverse"));
const fixup_var_scoping_1 = __importDefault(require("./fixup-var-scoping"));
const babel_helper_mark_eval_scopes_1 = __importDefault(require("babel-helper-mark-eval-scopes"));
const markEvalScopes = babel_helper_mark_eval_scopes_1.default.markEvalScopes, isEvalScopesMarked = babel_helper_mark_eval_scopes_1.default.isMarked, hasEval = babel_helper_mark_eval_scopes_1.default.hasEval;
const newIssueUrl = "https://github.com/babel/minify/issues/new";
exports.default = babel => {
    const t = babel.types, traverse = babel.traverse;
    const bfsTraverse = (0, bfs_traverse_1.default)(babel);
    const hop = Object.prototype.hasOwnProperty;
    class Mangler {
        constructor(charset, program, { exclude = {}, keepFnName = false, keepClassName = false, eval: _eval = false, topLevel = false } = {}) {
            ...
            this.scopeTracker = new scope_tracker_1.default();
        ...
        /**
            ...
            */
        fixup() {
            (0, fixup_var_scoping_1.default)(this);
        }
        /**
        ...
        collect() {
            ...
            const collectVisitor = {
                ...
                ReferencedIdentifier(path) {
                    if ((0, is_label_identifier_1.default)(path)) {
                        return;
                    }
                    const scope = path.scope, name = path.node.name;
        ...
        rename(scope, binding, oldName, newName) {
            ...
            for (let i = 0; i < refs.length; i++) {
                ...
                else if (!(0, is_label_identifier_1.default)(path)) {
        ...
        visitor: {
            ...
            Program: {
                exit(path) {
                    ...
                    const charset = new charset_1.default(shouldConsiderSource);
