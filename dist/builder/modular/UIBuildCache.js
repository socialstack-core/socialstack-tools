...
class UIBuildCache {
    ...
    writeToFile() {
        return new Promise((s, r) => {
            // Ensure dir exists:
            fs_1.default.mkdir(this.cacheDir, { recursive: true }, (err) => {
                if (err && err.code != 'EEXIST')
                    throw err;
                // Write to it:
                fs_1.default.writeFile(this.path, JSON.stringify(this.data, null, '\t'), err => err ? r(err) : s());
            });
        });
    }
    /// <summary>
