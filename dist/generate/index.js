...
const { generateInstallCommand } = helpers_js_1.default;
/*
...
exports.default = (config) => {
    ...
    function createModule(moduleSet, type, names) {
        ...
        var singular = pluralize_1.default.singular(entity);
    ...
    function copyTemplate(templateDir, swaps, targetDirectory, generatedName) {
        fs_1.default.readdir(templateDir, function (err, files) {
            ...
            files.forEach(file => {
                ...
                // Read the content:
                var sourceContent = fs_1.default.readFileSync(templateDir + '/' + file, { encoding: 'utf8' });
                var swappedContent = swap(sourceContent, swaps);
                fs_1.default.writeFileSync(targetDirectory + '/' + targetName, swappedContent, { encoding: 'utf8' });
            });
    ...
    function handleModule() {
        ...
        if (pieces.length == 1) {
            ...
            if (first == 'nginx') {
                ...
                (0, translations_js_1.default)(config);
                return;
            }
            else if (first == 'sql') {
        ...
        if (firstPiece == 'api') {
            ...
            if (pluralize_1.default.isPlural(entity)) {
                ...
                askFor('You\'ve provided a singular name (' + entity + '). ' +
                    ...
                    'Otherwise enter N to exit.', 'serviceonly').then(config => {
                    console.log(config);
