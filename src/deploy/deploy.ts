// @ts-nocheck
import mod_zyv89 from './helpers.js';
const { remoteFileList, localFileList,diff, copyDirectory, 
	uploadFile, createRemoteDirectory, extractPatch, 
	setPermsAndUser, setupOrRestartService, handleRenames, getAppSettings, reloadUI   } = mod_zyv89;
import hostHelpers from '../host/helpers.js';
import cloudHelpers from '../cloud/helpers.js';
...
function deployToHost(host, config, verbose, uiOnly, content, commit){
	...
	return hostHelpers.connect(host)
	.then(connection => {
