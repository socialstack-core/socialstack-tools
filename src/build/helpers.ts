...
function updateHtmlFile(publicUrl: string, fileInfo: any, publicDir: string, config: SocialStackConfig, htmlFileName: string, optional: boolean) {
...
*/
function processCss(cssFile: string, config: SocialStackConfig) {
	if (!config.__postCss) {
		// Disabled.
...
function getCustomBuildConfig(path: string) {
...
function generateAliases(map: any) {
...
function watchOrBuild(config: SocialStackConfig, isWatch: boolean) {
...
function buildAll(opts: any, config: SocialStackConfig) {
	opts = opts || {};
	var promises = [];
...
function buildUI(config: SocialStackConfig, isWatch: boolean) {
...
function buildAPI(config: SocialStackConfig) {
