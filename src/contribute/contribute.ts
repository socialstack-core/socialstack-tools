...
import mod_euoci from '../install/helpers.js';
const { runCmd   } = mod_euoci;
import rimraf from 'rimraf';
import readline from 'readline';

import mod_maat1 from '../install/helpers.js';
const { getModuleMap, getModuleIdMap, searchForModules,
