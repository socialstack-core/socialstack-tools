...
import dynamicModule1 from 'pathStrings';
import dynamicModule2 from '@babel/preset-env';
import dynamicModule3 from '@babel/preset-react';
...
function transpile(map, text, modulePath, moduleNames){
	...
	try{
		return Babel.transform(
			text, {
				presets: [dynamicModule2, dynamicModule3],
